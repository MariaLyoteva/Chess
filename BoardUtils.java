...
public enum  BoardUtils {
    ...
    private Map<String, Integer> initializePositionToCoordinateMap() {
     ...
     // algebraic notation - a.k.a. the letters and numbers on a normal chess board 
    ...
    public static boolean isThreatenedBoardImmediate(final Board board) {
     ...
     // checks if the current's player king is in check 
    ...
    //used for getting the move history

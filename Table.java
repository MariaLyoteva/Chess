...
public final class Table extends Observable {
    ...
    private Table() {
        this.gameFrame = new JFrame("ChessPlayer");
        ...
        this.pieceIconPath = "C:\\ChessProject\\BlackWidow-Chess-master\\art1\\holywarriors";
        ...
        protected Move doInBackground() {
           final Move bestMove;
            final Move bookMove = Table.get().getUseBook()
                    ? MySqlGamePersistence.get().getNextBestMove(Table.get().getGameBoard(), //please don't mind me, I'm work in progress. 
        ...
        private void assignTilePieceIcon(final Board board) {
            this.removeAll();
             if(board.getPiece(this.tileId) != null) {
                try{
                	final String path = pieceIconPath + "\\"+
